function snm_1_2_rev5_fitting_Ensemble(iteration, iteration_max)
...
fitnessfcn = @(w) snm_1_2_rev5_fitness_gender(w,w_map,w_full,exptin,exptout,inputs_idx,gender_value);
