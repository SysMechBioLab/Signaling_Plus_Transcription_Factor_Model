function [speciesNames,y_ctrl,y_perturb,y_full,y_out] = StratificationSimulation_singledose(w,w_map,w_full,exptin,exptout,inputs_idx,gender_value,perturb_nodes,perturb_lvl) 
