...
parfor run = 1:size(x_all, 1)
    ...
    [~,y_out,y_full,y_delta,y_delta_full,SE] = EnsembleFitness_training(w, ...
        w_map, ...
        w_full, ...
        exptin, ...
        exptout, ...
...
[speciesNames,y_out_nofit,y_full_nofit,y_delta_nofit,y_delta_full_nofit,SE_nofit] = EnsembleFitness_training(w_nofit, ...
    w_map, ...
    w_full, ...
    exptin, ...
    exptout, ...
