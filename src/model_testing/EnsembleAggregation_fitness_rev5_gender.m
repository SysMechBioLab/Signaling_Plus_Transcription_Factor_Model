function [speciesNames,y_out,y_full,y_delta,y_delta_full,SE] = EnsembleAggregation_fitness_rev5_gender(w,w_map,w_full,exptin,exptout,inputs_idx,gender_value) 
